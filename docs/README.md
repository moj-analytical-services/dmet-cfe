...
![bg right 60%](./images/bullseye.png)
...
![bg right:40% 90%](./images/goal.png)
...
.scaled-iframe {
  transform: scale(0.9); /* Scale the iframe content down to 50% */
  transform-origin: top left; /* Set the origin for scaling */
  width: 110%; /* Adjust width to compensate for scaling */
  height: 110%; /* Adjust height to compensate for scaling */
